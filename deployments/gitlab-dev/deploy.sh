...
helm upgrade --install gitlab-umbrella-dev /Users/jakoberpf/Code/jakoberpf/kubernetes/charts/charts/gitlab --namespace=gitlab-dev --values=values-umbrella.yaml
